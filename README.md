...
**Vídeo**
- **Load Video** / **Save Video** — equivalentes ao VHS com tipo `VIDEO` nativo (nodes 2.0), preview já cortado por skip/cap/nth/force_rate, export com mais controle de codec/CRF. O **Load Video** tem widget **`reverse`** que inverte a ordem dos frames.
